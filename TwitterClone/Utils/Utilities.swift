...
class Uitilities{
    ...
    func textField(withPlaceholder placeholer: String) -> UITextField{
        ...
        tf.attributedPlaceholder = NSAttributedString(string: placeholer, attributes: [NSAttributedString.Key.foregroundColor: UIColor.white])
         return tf
